...
export default function ImagePreview({ src, alt, onClose }) {
  ...
  return (
    <div className="modal-backdrop fixed inset-0 z-[60] bg-black/80 flex items-center justify-center p-5" onClick={onClose}>
      <div className="modal-panel relative max-w-4xl max-h-[90vh]" onClick={(event) => event.stopPropagation()}>
